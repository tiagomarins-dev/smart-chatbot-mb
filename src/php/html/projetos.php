...
<head>
    ...
    <title>Projetos - Smart-ChatBox</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="projetos.php"><i class="fas fa-project-diagram me-1"></i> Projetos</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-12">
                <div class="card fade-in">
                    <div class="card-body text-center py-5">
                        <div class="mb-4">
                            <i class="fas fa-project-diagram display-1 text-primary"></i>
                        </div>
                        <h2 class="mb-3">Acesso aos Projetos</h2>
                        <p class="lead mb-4">Você precisa estar autenticado para gerenciar seus projetos.</p>
                ...
                <div class="col-md-3">
                    ...
                    <div class="card mb-4 fade-in">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="fas fa-filter me-2"></i>Filtrar por Empresa</h5>
                        </div>
                        <div class="card-body">
                            <div id="company-filter-loading" class="text-center my-3">
                ...
                <div class="col-md-9">
                    ...
                    <div id="projects-container">
                                ...
                                <div id="projects-empty" class="text-center my-5 d-none">
                                    ...
                                    <p class="mt-3">Você ainda não cadastrou nenhum projeto.</p>
                                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#projectModal">
                                        <i class="fas fa-plus-circle me-1"></i> Cadastrar Projeto
                                    </button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="project-form">
                        ...
                        <div class="mb-3">
                            <label for="project-company" class="form-label">Empresa</label>
                            <select class="form-select" id="project-company" required>
                                <option value="">Selecione uma empresa</option>
                                <!-- Preenchido via JavaScript -->
                            </select>
                            <div class="form-text">A empresa à qual o projeto está vinculado.</div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="project-campaign-start" class="form-label">Data de Início da Campanha</label>
                                <input type="date" class="form-control" id="project-campaign-start">
                                <div class="form-text">Data de início da campanha</div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="project-campaign-end" class="form-label">Data de Término da Campanha</label>
                                <input type="date" class="form-control" id="project-campaign-end">
                                <div class="form-text">Data de encerramento da campanha</div>
                            </div>
                        </div>
                        <div class="mb-3" id="project-status-container">
                            <label class="form-label">Status</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="project-status" id="project-status-active" value="true" checked>
                                <label class="form-check-label" for="project-status-active">
                                    Ativo
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="project-status" id="project-status-inactive" value="false">
                                <label class="form-check-label" for="project-status-inactive">
                                    Inativo
                                </label>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="save-project-btn">Salvar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Tem certeza que deseja desativar o projeto "<span id="delete-project-name"></span>"?</p>
                    <p class="text-muted">Esta ação não exclui permanentemente o projeto, apenas o desativa no sistema.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
    ...
    <script type="importmap">
        {
            "imports": {
                ...
                "./projects.js": "./assets/js/projects.js"
            }
        }
    </script>
    <script type="module">
        import './assets/js/main.js';
        import ProjectsManager from './assets/js/projects.js';
